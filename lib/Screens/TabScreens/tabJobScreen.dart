...
class TabJobScreen extends StatelessWidget {
  ...
  final int index;
  const TabJobScreen({Key? key, this.onPush, required this.index})
      : super(key: key);

  String totalSpi(List<PlannedvsActualResource> list) {
    double total = 0;
    for (PlannedvsActualResource res in list) {
      total += res.allowableResources ?? 0;
    }
    return total.toString();
  }

  String totalCpi(List<PlannedvsActualResource> list) {
    double total = 0;
    for (PlannedvsActualResource res in list) {
      total += res.allowableResources ?? 0;
    }
              ...
              children: [
                        ...
                        children: [
                          Expanded(
                            child: Container(
                                ...
                                child: Center(
                                    child: Text(
                                  values.getJC(index).activityCode,
                                  style: TextStyle(
                                    color: Colors.white,
                          ...
                          Expanded(
                            ...
                            child: Container(
                                ...
                                child: Center(
                                    child: Text(
                                  values.getJC(index).activiyName,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.w700,
                                  ),
                ...
                Expanded(
                  ...
                  child: SimpleTable(headings: [
                    ...
                    for (PlannedvsActualResource res
                        in values.getJC(index).plannedvsactuals)
                      SimpleTableElement(
                        onTap: null,
                        datas: [
                    ...
                    SimpleTableElement(
                      ...
                      datas: [
                        TableValueElement(
                          "Quantity to be acheived : ${values.getJC(index).tobeAchievedQTY}",
                          flex: 5,
                          useCustomflex: true,
                          textAlign: TextAlign.left,
                        ),
                        TableValueElement(
                            totalSpi(values.getJC(index).plannedvsactuals),
                            flex: 1,
                            useCustomflex: true,
                            color: Colors.green),
                        TableValueElement(
                            totalCpi(values.getJC(index).plannedvsactuals),
                            flex: 1,
                            useCustomflex: true,
                            color: Colors.red),
                      ],
                ...
                if (values.getJC(index).plannedvsactuals.length == 0)
                  Expanded(
                    flex: 48,
                    child: Text(
                    ...
                    children: [
                              ...
                              child: TextField(
                                onChanged: (str) {
                                  Provider.of<ProviderModel>(context,
                                          listen: false)
                                      .updateQty(
                                          double.tryParse(str) ?? 0, index);
                                  values.getJC(index).achievedQTY =
                      ...
                      Container(
                          ...
                          child: Padding(
                              padding: EdgeInsets.all(8),
                              child:
                                  Text(values.getJC(index).tobeAchievedQTY))),
                      CircleButton(
                        icon: Icon(
                          Icons.save,
                          size: 30,
                                ...
                                TextButton(
                                  ...
                                  onPressed: () async {
                                    int stat = await Provider.of<ProviderModel>(
                                            context)
                                        .execute(values.getJC(index));
                                    if (stat == 200)
                                      ScaffoldMessenger.of(context)
                                          .showSnackBar(SnackBar(
                                        content: Text(
                                            "JobCard Succesfully Executed!"),
                                      ));
                                    Navigator.pop(context);
                                  },
                                )
